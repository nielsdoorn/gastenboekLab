...
if (isset($_POST['aktie']) && $_POST['aktie'] == 'nieuwbericht') {
	// verander het naam, email en bericht veld in de ingevulde waarden
	voegBerichtToe($_POST['titel'], "naam", "email", "tekst");
}
...
<div id="container">
	...
	<div id="main">
		...
		<!-- OPDRACHT:  zorg ervoor dat het formulier op de juiste manier vertuurd wordt -->
		<form action="" method="">
			<h2>Nieuw bericht</h2>
